...
6. **Airplane mode, fresh account.** Expect "Server unreachable — nothing was founded", and *Not enrolled* still on screen afterwards; nothing was written.
